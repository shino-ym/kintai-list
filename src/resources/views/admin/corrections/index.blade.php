...
<div class="correction-container">
    ...
    {{-- タブメニュー --}}
    <div class="tab-menu">
        <a href="{{ route('admin.attendance_corrections.index', ['tab' => 'pending']) }}"
            class="tab {{ $tab === 'pending' ? 'active' : '' }}">
            承認待ち
        </a>

        <a href="{{ route('admin.attendance_corrections.index', ['tab' => 'approved']) }}"
    ...
    <hr class="separator">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    @if($correction->id)
                        <a class="detail" href="{{ route('admin.attendance_corrections.show', ['attendance_correct_request_id' => $correction->id]) }}">
                            詳細
                        </a>
                    @else
                        -
